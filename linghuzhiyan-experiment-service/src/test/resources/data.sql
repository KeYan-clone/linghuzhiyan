...
('eval2', 'sub1', 'user1', 'task1', NULL, 'PENDING', NULL, NULL, NULL, NULL, DATEADD('HOUR', -1, NOW()), NOW()),
('eval3', 'sub2', 'user2', 'task2', 0.00, 'FAILED', 'Test failed', FALSE, NULL, NULL, DATEADD('MINUTE', -30, NOW()), DATEADD('MINUTE', -15, NOW()));
