...
class ExperimentControllerTest {
    ...
    void setUp() {
        ...
        experimentRequestDTO.setStatus(org.linghu.experiment.domain.Experiment.ExperimentStatus.DRAFT);
    ...
    class ExperimentStatusTests {
        ...
        void shouldPublishExperimentSuccessfully() {
            ...
            assertThat(response.getData().getStatus()).isEqualTo(org.linghu.experiment.domain.Experiment.ExperimentStatus.PUBLISHED);
        ...
        void shouldUnpublishExperimentSuccessfully() {
            ...
            assertThat(response.getData().getStatus()).isEqualTo(org.linghu.experiment.domain.Experiment.ExperimentStatus.DRAFT);
