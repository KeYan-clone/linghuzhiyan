...
import org.linghu.experiment.dto.PageResult;
...
class QuestionControllerTest {
    ...
    void setUp() {
        ...
        // 创建测试题目DTO
        sampleQuestionDTO = new QuestionDTO();
        sampleQuestionDTO.setId("q123");
        sampleQuestionDTO.setContent("测试题目内容");
        sampleQuestionDTO.setQuestionType(QuestionType.SINGLE_CHOICE);
        sampleQuestionDTO.setTags("测试,单选");
        sampleQuestionDTO.setCreatedAt("2023-12-01T10:00:00");
        sampleQuestionDTO.setUpdatedAt("2023-12-01T10:00:00");

        // 创建测试题目请求
        questionRequestDTO = new QuestionRequestDTO();
        questionRequestDTO.setContent("测试题目内容");
        questionRequestDTO.setQuestionType(QuestionType.SINGLE_CHOICE);
        questionRequestDTO.setTags("测试,单选");
        questionRequestDTO.setScore(new java.math.BigDecimal("10"));
    ...
    class UpdateQuestionTests {
        ...
        void shouldUpdateQuestionSuccessfully() {
            ...
            updatedQuestion.setContent("更新后的题目内容");
            updatedQuestion.setQuestionType(QuestionType.MULTIPLE_CHOICE);
            updatedQuestion.setTags("更新,多选");
            updatedQuestion.setUpdatedAt("2023-12-01T11:00:00");
