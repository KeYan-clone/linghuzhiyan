...
class ExperimentTaskControllerTest {
    ...
    void setUp() {
        ...
        // 创建测试任务请求
        taskRequestDTO = new ExperimentTaskRequestDTO();
        taskRequestDTO.setTitle("测试任务标题");
        taskRequestDTO.setDescription("测试任务描述");
        taskRequestDTO.setTaskType(org.linghu.experiment.constants.TaskType.CODE);
        taskRequestDTO.setRequired(true);
    ...
    class UpdateTaskTests {
        ...
        void shouldUpdateTaskSuccessfully() {
            // given
            ExperimentTaskDTO updatedTask = new ExperimentTaskDTO();
            updatedTask.setId("task123");
            updatedTask.setTitle("更新后的任务标题");
            updatedTask.setDescription("更新后的任务描述");
            updatedTask.setExperimentId("exp123");
            updatedTask.setOrderNum(2);
            updatedTask.setTaskType(org.linghu.experiment.constants.TaskType.OTHER);
            updatedTask.setRequired(false);
